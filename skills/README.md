...
| Skill                                                                 | What it does                                                                                                                                                                                                                                                                                                        |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`setup-nest-profiler`](setup-nest-profiler/SKILL.md)                 | Install and configure the core profiler end-to-end: introspect the project, pick the install (dev dependency + dev entrypoint by default, or `dependencies` + `ConditionalModule` when production code calls the profiler), configure the core and each collector via targeted questions, capture logs, and verify. |
