...
| `isGlobal`         | `boolean`                  | `false`     | Register as a global NestJS module. If you also register `ProfilerNoopModule` (only needed when the app injects `TracerService` directly), keep `isGlobal` identical on it.                                                                                                                                                                                                                                                                                |
