...
seo:
  ...
  description: 'Complete API reference for @eleven-labs/nest-profiler-config: the types and options of the configuration snapshot collector that captures a flattened @nestjs/config view with secret masking.'
---
