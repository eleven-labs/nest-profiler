...
Open `/_profiler` and select the **Schemas / Mongoose** view — it has the same shape as every ORM's, one disclosure per model over a columns table (see the [TypeORM walkthrough](/docs/tutorials/typeorm-collector) for a shot of it).
