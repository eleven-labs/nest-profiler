 ...
 * root. The catalog needs Postgres (one of the two SQL adapters); content, auth, health, diagnostics
 * and the in-process event emitter need nothing. GraphQL and RabbitMQ are gated inside their own
 * contexts; only Mongoose-backed reviews and the logger choice are gated here.
 *
