...
First stable release. `@eleven-labs/nest-profiler-graphql` brings GraphQL into the profiler: queries and mutations get their own sidebar view and a dedicated **GraphQL** detail tab.
