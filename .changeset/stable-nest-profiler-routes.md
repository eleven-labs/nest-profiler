...
First stable release. `@eleven-labs/nest-profiler-routes` adds the **Discover** views to the profiler home — a Symfony-Routing-style view of what the application actually registered.
