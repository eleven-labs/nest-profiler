---
'@eleven-labs/nest-profiler-mikro-orm': major
---

First stable release. `@eleven-labs/nest-profiler-mikro-orm` captures every SQL query MikroORM runs during a profiled execution and shows it in a **Database** panel.
