---
'@eleven-labs/nest-profiler-cache': major
---

First stable release. `@eleven-labs/nest-profiler-cache` intercepts `@nestjs/cache-manager` operations during a profiled execution and shows them in a **Cache** panel.
