---
'@eleven-labs/nest-profiler-validator': major
---

First stable release. `@eleven-labs/nest-profiler-validator` captures every DTO validation result — valid or invalid — and shows it in a **Validator** panel, after Symfony's validator tab.
