---
'@eleven-labs/nest-profiler-config': major
---

First stable release. `@eleven-labs/nest-profiler-config` snapshots the application configuration at startup and shows it in a global **Config** panel.
