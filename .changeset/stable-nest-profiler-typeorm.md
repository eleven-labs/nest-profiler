---
'@eleven-labs/nest-profiler-typeorm': major
---

First stable release. `@eleven-labs/nest-profiler-typeorm` captures every SQL query TypeORM runs during a profiled execution and shows it in a **Database** panel.
