...
- 3a507ec: First stable release. `@eleven-labs/nest-profiler-event-emitter` captures the domain events an application dispatches through `@nestjs/event-emitter`.
