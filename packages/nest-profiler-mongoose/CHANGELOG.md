...
- 3a507ec: First stable release. `@eleven-labs/nest-profiler-mongoose` captures every Mongoose query and aggregation run during a profiled execution and shows it in a **MongoDB** panel.
