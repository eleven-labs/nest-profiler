export { CommanderCollectorModule } from './commander-collector.module';
export type { CommanderCollectorModuleOptions } from './commander-collector.module';
...
export { CommanderDiscoverSource } from './commander-discover-source';
